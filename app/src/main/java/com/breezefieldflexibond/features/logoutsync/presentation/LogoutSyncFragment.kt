package com.breezefieldflexibond.features.logoutsync.presentation
...
import com.breezefieldflexibond.app.AppDatabase
...
import com.breezefieldflexibond.app.utils.Toaster
import com.breezefieldflexibond.base.BaseResponse
import com.breezefieldflexibond.base.presentation.BaseActivity
import com.breezefieldflexibond.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldflexibond.features.billing.api.AddBillingRepoProvider
import com.breezefieldflexibond.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldflexibond.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldflexibond.features.document.model.AddEditDocumentInputParams
import com.breezefieldflexibond.features.document.model.DocumentAttachmentModel
...
import com.breezefieldflexibond.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldflexibond.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldflexibond.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldflexibond.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldflexibond.features.orderhistory.model.*
...
import com.breezefieldflexibond.features.quotation.model.AddQuotInputModel
import com.breezefieldflexibond.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldflexibond.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldflexibond.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldflexibond.features.stock.api.StockRepositoryProvider
import com.breezefieldflexibond.features.stock.model.AddStockInputParamsModel
...
import com.breezefieldflexibond.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldflexibond.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldflexibond.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldflexibond.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldflexibond.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldflexibond.mappackage.SendBrod
import com.breezefieldflexibond.widgets.AppCustomTextView
import com.breezefieldflexibond.MonitorService
import com.breezefieldflexibond.MySingleton
import com.breezefieldflexibond.app.AlarmReceiver
...
import com.breezefieldflexibond.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldflexibond.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldflexibond.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldflexibond.features.orderITC.SyncDeleteOpptL
import com.breezefieldflexibond.features.orderITC.SyncEditOppt
import com.breezefieldflexibond.features.orderITC.SyncOppt
import com.breezefieldflexibond.features.orderITC.SyncOpptProductL
import com.breezefieldflexibond.features.orderITC.SyncOrd
import com.breezefieldflexibond.features.orderITC.SyncOrdProductL
import com.breezefieldflexibond.features.performance.model.Gps_status_list
import com.breezefieldflexibond.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldflexibond.features.returnsOrder.ReturnProductList
import com.breezefieldflexibond.features.returnsOrder.ReturnRequest
import com.breezefieldflexibond.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldflexibondlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldflexibondlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldflexibondlogsample/log.zip").path);
