...
import com.flexibond.*
import com.flexibond.R
import com.flexibond.app.*
import com.flexibond.app.NewFileUtils.browseDocuments
import com.flexibond.app.NewFileUtils.getExtension
import com.flexibond.app.domain.*
import com.flexibond.app.types.DashboardType
import com.flexibond.app.types.FragType
import com.flexibond.app.types.TopBarConfig
import com.flexibond.app.uiaction.DisplayAlert
import com.flexibond.app.utils.*
import com.flexibond.app.utils.AppUtils.Companion.isProfile
...
import com.flexibond.features.NewQuotation.*
import com.flexibond.features.NewQuotation.api.GetQuotRegProvider
import com.flexibond.features.NewQuotation.model.ViewDetailsQuotResponse
import com.flexibond.features.SearchLocation.SearchLocationFragment
import com.flexibond.features.SearchLocation.locationInfoModel
import com.flexibond.features.TA.ViewAllTAListFragment
import com.flexibond.features.achievement.AchievementFragment
import com.flexibond.features.activities.presentation.*
import com.flexibond.features.addAttendence.*
import com.flexibond.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.flexibond.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.flexibond.features.addAttendence.model.GetReportToFCMResponse
import com.flexibond.features.addAttendence.model.GetReportToResponse
import com.flexibond.features.addAttendence.model.Leave_list_Response
import com.flexibond.features.addorder.presentation.AddOrderFragment
import com.flexibond.features.addshop.model.AddShopRequestData
import com.flexibond.features.addshop.model.AddShopResponse
import com.flexibond.features.addshop.presentation.AddShopFragment
import com.flexibond.features.addshop.presentation.OTPVerificationDialog
import com.flexibond.features.addshop.presentation.ScanImageFragment
import com.flexibond.features.addshop.presentation.ShowCardDetailsDialog
import com.flexibond.features.alarm.model.AlarmData
import com.flexibond.features.alarm.presetation.AttendanceReportFragment
import com.flexibond.features.alarm.presetation.PerformanceReportFragment
import com.flexibond.features.alarm.presetation.VisitReportDetailsFragment
import com.flexibond.features.alarm.presetation.VisitReportFragment
import com.flexibond.features.attendance.AttendanceFragment
import com.flexibond.features.attendance.api.AttendanceRepositoryProvider
import com.flexibond.features.attendance.model.AttendanceRequest
import com.flexibond.features.attendance.model.AttendanceResponse
import com.flexibond.features.averageshop.presentation.AverageShopFragment
import com.flexibond.features.avgorder.presentation.AverageOrderFragment
import com.flexibond.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.flexibond.features.beatCustom.TeamBeatListFragment
import com.flexibond.features.billing.presentation.AddBillingFragment
import com.flexibond.features.billing.presentation.BillingDetailsFragment
import com.flexibond.features.billing.presentation.BillingListFragment
import com.flexibond.features.changepassword.presentation.ChangePasswordDialog
import com.flexibond.features.chat.model.ChatListDataModel
import com.flexibond.features.chat.model.ChatUserDataModel
import com.flexibond.features.chat.model.GroupUserDataModel
import com.flexibond.features.chat.presentation.*
import com.flexibond.features.chatbot.presentation.ChatBotFragment
import com.flexibond.features.chatbot.presentation.ChatBotShopListFragment
import com.flexibond.features.chatbot.presentation.ReportsFragment
import com.flexibond.features.chatbot.presentation.SelectLanguageDialog
import com.flexibond.features.commondialog.presentation.CommonDialog
import com.flexibond.features.commondialog.presentation.CommonDialogClickListener
import com.flexibond.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.flexibond.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.flexibond.features.commondialogsinglebtn.OnDialogClickListener
import com.flexibond.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.flexibond.features.dailyPlan.prsentation.AllShopListFragment
import com.flexibond.features.dailyPlan.prsentation.DailyPlanListFragment
import com.flexibond.features.dailyPlan.prsentation.PlanDetailsFragment
import com.flexibond.features.damageProduct.ShopDamageProductListFrag
import com.flexibond.features.damageProduct.ShopDamageProductSubmitFrag
import com.flexibond.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.flexibond.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.flexibond.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.flexibond.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.flexibond.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.flexibond.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.flexibond.features.dashboard.presentation.model.ContentListResponseModel
import com.flexibond.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.flexibond.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.flexibond.features.device_info.presentation.DeviceInfoListFragment
import com.flexibond.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.flexibond.features.document.DocumentRepoFeatureNewFragment
import com.flexibond.features.document.presentation.DocumentListFragment
import com.flexibond.features.document.presentation.DocumentTypeListFragment
import com.flexibond.features.document.presentation.OpenFileWebViewFragment
import com.flexibond.features.dymanicSection.presentation.AddDynamicFragment
import com.flexibond.features.dymanicSection.presentation.AllDynamicListFragment
import com.flexibond.features.dymanicSection.presentation.DynamicListFragment
import com.flexibond.features.dymanicSection.presentation.EditDynamicFragment
import com.flexibond.features.gpsDisabilityScreen.GpsDisableFragment
import com.flexibond.features.home.presentation.HomeFragment
import com.flexibond.features.homelocation.presentation.HomeLocationFragment
import com.flexibond.features.homelocation.presentation.HomeLocationMapFragment
import com.flexibond.features.know_your_state.KnowYourStateFragment
import com.flexibond.features.lead.LeadFrag
import com.flexibond.features.lead.ViewLeadFrag
import com.flexibond.features.leaveapplynew.LeaveHome
import com.flexibond.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.flexibond.features.localshops.LocalShopListFragment
import com.flexibond.features.localshops.LocalShopListMapFragment
import com.flexibond.features.localshops.NearByShopsMapFragment
import com.flexibond.features.location.*
import com.flexibond.features.location.api.LocationRepoProvider
import com.flexibond.features.location.model.*
import com.flexibond.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.flexibond.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.flexibond.features.login.ShopFeedbackEntity
import com.flexibond.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.flexibond.features.login.presentation.LoginActivity
import com.flexibond.features.logout.presentation.api.LogoutRepositoryProvider
import com.flexibond.features.logoutsync.presentation.LogoutSyncFragment
import com.flexibond.features.marketing.presentation.MarketingPagerFragment
import com.flexibond.features.meetinglist.prsentation.MeetingListFragment
import com.flexibond.features.member.MapViewForTeamFrag
import com.flexibond.features.member.model.TeamLocDataModel
import com.flexibond.features.member.model.TeamShopListDataModel
import com.flexibond.features.member.presentation.*
import com.flexibond.features.menuBeat.MenuBeatFrag
import com.flexibond.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.flexibond.features.micro_learning.presentation.MicroLearningListFragment
import com.flexibond.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.flexibond.features.myallowancerequest.MyallowanceRequestFragment
import com.flexibond.features.myjobs.model.CustomerDataModel
import com.flexibond.features.myjobs.presentation.*
import com.flexibond.features.myorder.presentation.MyOrderListFragment
import com.flexibond.features.myprofile.presentation.MyProfileFragment
import com.flexibond.features.nearbyshops.api.ShopListRepositoryProvider
import com.flexibond.features.nearbyshops.model.ShopData
import com.flexibond.features.nearbyshops.model.ShopListResponse
import com.flexibond.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.flexibond.features.nearbyshops.presentation.BeatListFragment
import com.flexibond.features.nearbyshops.presentation.NearByShopsListFragment
import com.flexibond.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.flexibond.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.flexibond.features.newcollection.CollectionDetailsStatusFragment
import com.flexibond.features.newcollection.CollectionShopListFragment
import com.flexibond.features.newcollection.NewCollectionListFragment
import com.flexibond.features.newcollectionreport.*
import com.flexibond.features.notification.NotificationFragment
import com.flexibond.features.orderList.NewDateWiseOrderListFragment
import com.flexibond.features.orderList.NewOrderListFragment
import com.flexibond.features.orderList.OrderListFragment
import com.flexibond.features.orderdetail.presentation.OrderDetailFragment
import com.flexibond.features.orderhistory.ActivityMapFragment
import com.flexibond.features.orderhistory.OrderhistoryFragment
import com.flexibond.features.orderhistory.TimeLineFragment
import com.flexibond.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.flexibond.features.orderhistory.model.FetchLocationRequest
import com.flexibond.features.orderhistory.model.FetchLocationResponse
import com.flexibond.features.orderhistory.model.LocationData
import com.flexibond.features.pendinglocationinout.PendingOutLocationFrag
import com.flexibond.features.performance.GpsStatusFragment
import com.flexibond.features.performance.PerformanceFragment
import com.flexibond.features.performance.api.UpdateGpsStatusRepoProvider
import com.flexibond.features.performance.model.UpdateGpsInputParamsModel
import com.flexibond.features.performanceAPP.PerformanceAppFragment
import com.flexibond.features.permissionList.ViewPermissionFragment
import com.flexibond.features.photoReg.*
import com.flexibond.features.privacypolicy.PrivacypolicyWebviewFrag
import com.flexibond.features.quotation.presentation.*
import com.flexibond.features.reimbursement.presentation.*
import com.flexibond.features.report.presentation.*
import com.flexibond.features.returnsOrder.*
import com.flexibond.features.settings.presentation.SettingsFragment
import com.flexibond.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.flexibond.features.shopdetail.presentation.*
import com.flexibond.features.shopdetail.presentation.api.EditShopRepoProvider
import com.flexibond.features.stock.StockDetailsFragment
import com.flexibond.features.stock.StockListFragment
import com.flexibond.features.stockAddCurrentStock.AddShopStockFragment
import com.flexibond.features.stockAddCurrentStock.UpdateShopStockFragment
import com.flexibond.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.flexibond.features.stockCompetetorStock.AddCompetetorStockFragment
import com.flexibond.features.stockCompetetorStock.CompetetorStockFragment
import com.flexibond.features.stockCompetetorStock.ViewComStockProductDetails
import com.flexibond.features.survey.SurveyFrag
import com.flexibond.features.survey.SurveyViewDtlsFrag
import com.flexibond.features.survey.SurveyViewFrag
import com.flexibond.features.task.presentation.AddTaskFragment
import com.flexibond.features.task.presentation.CalenderTaskFragment
import com.flexibond.features.task.presentation.EditTaskFragment
import com.flexibond.features.task.presentation.TaskListFragment
import com.flexibond.features.taskManagement.TaskManagementFrag
import com.flexibond.features.taskManagement.ViewTaskManagementFrag
import com.flexibond.features.timesheet.presentation.AddTimeSheetFragment
import com.flexibond.features.timesheet.presentation.EditTimeSheetFragment
import com.flexibond.features.timesheet.presentation.TimeSheetListFragment
import com.flexibond.features.viewAllOrder.CartFragment
import com.flexibond.features.viewAllOrder.OrderTypeListFragment
import com.flexibond.features.viewAllOrder.ViewAllOrderListFragment
import com.flexibond.features.viewAllOrder.ViewCartFragment
import com.flexibond.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.flexibond.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.flexibond.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.flexibond.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.flexibond.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.flexibond.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.flexibond.features.viewPPDDStock.ViewOutstandingFragment
import com.flexibond.features.viewPPDDStock.ViewPPDDListFragment
import com.flexibond.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.flexibond.features.viewPPDDStock.ViewStockFragment
import com.flexibond.features.weather.presentation.WeatherFragment
import com.flexibond.mappackage.MapActivity
import com.flexibond.mappackage.MapActivityWithoutPath
import com.flexibond.mappackage.SendBrod
import com.flexibond.widgets.AppCustomEditText
...
import com.flexibond.app.NewFileUtils.browsePDFDocuments
import com.flexibond.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xflexibondlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.flexibond/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
