package com.flexibond.features.logoutsync.presentation
...
import com.flexibond.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.flexibond.features.billing.api.AddBillingRepoProvider
import com.flexibond.features.billing.model.AddBillingInputParamsModel
...
import com.flexibond.features.dashboard.presentation.ReasonDialog
...
import com.flexibond.features.document.model.AddEditDocumentInputParams
import com.flexibond.features.document.model.DocumentAttachmentModel
...
import com.flexibond.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.flexibond.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.flexibond.features.orderhistory.model.*
...
import com.flexibond.features.quotation.model.AddQuotInputModel
import com.flexibond.features.shopdetail.presentation.api.EditShopRepoProvider
import com.flexibond.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.flexibond.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.flexibond.features.stock.api.StockRepositoryProvider
import com.flexibond.features.stock.model.AddStockInputParamsModel
import com.flexibond.features.stockAddCurrentStock.AddShopStockFragment
import com.flexibond.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.flexibond.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.flexibond.features.timesheet.model.AddTimeSheetInputModel
import com.flexibond.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.flexibond.features.viewAllOrder.model.AddOrderInputParamsModel
import com.flexibond.features.viewAllOrder.model.AddOrderInputProductList
import com.flexibond.mappackage.SendBrod
import com.flexibond.widgets.AppCustomTextView
import com.flexibond.MonitorService
import com.flexibond.features.addshop.model.*
import com.flexibond.features.addshop.model.assigntopplist.AddShopUploadImg
import com.flexibond.features.addshop.presentation.ShopExtraContactReq
import com.flexibond.features.addshop.presentation.multiContactRequestData
import com.flexibond.features.login.api.LoginRepositoryProvider
import com.flexibond.features.login.model.GetConcurrentUserResponse
import com.flexibond.features.performance.model.Gps_status_list
import com.flexibond.features.performance.model.UpdateGpsInputListParamsModel
import com.flexibond.features.returnsOrder.ReturnProductList
import com.flexibond.features.returnsOrder.ReturnRequest
import com.flexibond.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xflexibondlogsample/log.zip").path);
